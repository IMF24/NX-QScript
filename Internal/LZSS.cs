// = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - =
//  L Z S S   C O M P R E S S I O N
//      Helper class for working with NX's in-house LZSS
...
// Code below was written by Nanook for his QueenBee application.
// The original code has been left unchanged, except documentation has been added
// for the IntelliSense popups across IDEs.

// All comments in the script remain unchanged, except where noted. Original source:
// https://github.com/Nanook/Queen-Bee/blob/master/QueenBeeParser/Qb/Lzss.cs

namespace NX_QScript.Internal {
    /// <summary>
    ///  Helper class for working with Neversoft's in-house LZSS compression algorithm.
    /// </summary>
    internal class LZSS {
        /// <summary>
        ///  Construct a new instance of LZSS.
        /// </summary>
        public LZSS() {
        ...
        /// <summary>
        ///  Decompress a file that is LZSS compressed.
        /// </summary>
        /// <param name="compressed">
        ///  Array of LZSS compressed bytes.
        /// </param>
        /// <returns>
        ///  New array of bytes containing the uncompressed data.
        /// </returns>
        ...
        /// <summary>
        ///  Decompresses an input stream to the output stream and returns the decompressed size.
        /// </summary>
        /// <param name="input">
        ...
        /// <summary>
        ///  Compresses a raw byte array via the Neversoft LZSS compression algorithm.
        /// </summary>
        /// <param name="data">
        ///  Input uncompressed array of bytes.
        /// </param>
        /// <returns>
        ///  Newly compressed data as a byte array.
        /// </returns>
        ...
        /// <summary>
        ///  Compresses the input stream to the output stream and returns the size of the compressed data.
        /// </summary>
        /// <param name="input">
        ///  Original input stream.
        /// </param>
        /// <param name="output">
        ///  Output stream to write the compressed data.
        /// </param>
        /// <returns>
        ...
        // ---------------------------------------------------------------------------- //
        //    D O   N O T   T O U C H   C O D E   B E L O W   T H I S   P O I N T !     //
        // ---------------------------------------------------------------------------- //
